                                ...
                                <div id="divMetodoPago" class="ogilvy-metodo centerBlock">
                                    ...
                                    <div class="ogilvy-iconomediodepago">
                                        <img id="imgPago" class="ogilvy-imagenpago"
                                             src="Seleccione%20medio%20de%20pago_fichiers/ogilvy-iconoTarjeta.png"
                                ...
                                <div class="col-xs-12">
                                    <div>
                                        <table id="GridViewPagoSimple"
                                            ...
                                            <tr class="ogilvy-mediodepago ogilvy-mediodepago-selecionado">
                                                ...
                                                <td style="width:370px;" align="left">
                                                    <div class="div_relleno"
                                                        ...
                                                        <span id="GridViewPagoSimple_ctl02_lbDesPagoSimple"
                                                              class="descripcionPago">TARJETA</span>
                        ...
                        <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 ogilvy-seleccionpago ogilvy-espacioseccion">
                            <div class="col-xs-12">
                                <div class="ogilvy-botonrelleno ogilvy-Sweep">
                                    <input type="button" name="bSiguiente" value="Pagar"
                                           onclick="this.disabled = true;document.getElementById('showLoading').style.display = 'block';setValues();__doPostBack('bSiguiente','')"
                                           id="bSiguiente" class="bSiguiente">
                                </div>
                                <div class="ogilvy-botonborder ogilvy-border-fade">
                                    <input type="button" name="bAnterior" value="Cancelar"
                                           onclick="this.disabled = true;document.getElementById('showLoading').style.display = 'block';__doPostBack('bAnterior','')"
                                           id="bAnterior" class="bAnterior">
                                </div>
                            </div>
                        </div>
                    </div>
