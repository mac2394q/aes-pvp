...
function errorSesion() {
	...
	text: "los datos ingresados de autentificacion no son correctos!",
	icon: "error",
	button: false, 
	timer: 6000 });
}
...
function bloqueoSesion() {
	swal({title: "Tenemos un problema!",
	text: "el usuario ha sido bloqueado por favor contacte con AES para mas detalles al respecto!",
	icon: "warning",
	button: false, 
	timer: 6000 });
}
