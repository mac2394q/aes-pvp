                                ...
                                <div class="card">
                                    <div id="top_bar2" class="card-header">
                                        ...
                                        <h2 class="form-section titulo"><i class="fa fa-business-time"></i>
                                            Verificacion de cumplimiento de requisitos</h2>
                                        <br>
                                        <h4 class="card-title parrafo ">Nota : este informe muestra el estado luego de terminada
                                        ...
                                        <a class="btn btn-secondary round waves-effect waves-light" href="<?php echo "verFicha.php?id=".$_GET['id']; ?>">
                                            <i class="fa fa-clipboard round  fa-2x"></i> &nbsp;&nbsp;Ver ficha de auditoria
                                        </a>
                             
                                        <a target="_blank" href="<?php echo "resumenAuditoriaPDF.php?id=".$_GET['id']; ?>" class="btn btn-secondary round waves-effect waves-light">
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body" >
                                            ...
                                            <br><br><br><br>
                                            <p class="card-text parrafo">Numero de rubricas evaluadas durante la auditoria :
