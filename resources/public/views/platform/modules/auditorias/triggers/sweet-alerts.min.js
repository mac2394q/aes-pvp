...
function errorRegistroEmpresa() {
	swal({title: "Tenemos un problema!",
	text: "El registro de la empresa no puedo ser realizada consulte con su administrador del sistema!",
	icon: "error",
	button: false, 
	timer: 6000 });
}
...
function registroEmpresa() {
	...
	text: "Registro de empresa realizado con exito!",
	icon: "success",
	button: false, 
	timer: 20000 });
}

function modificacionEmpresa() {
	swal({title: "Enhorabuena!",
	text: "modificacion del registro empresa realizada con exito!",
	icon: "success",
	button: false, 
	timer: 20000 });
}

function inhabilitarEmpresa() {
	swal({title: "Enhorabuena!",
	text: "Empresa inhabilitada   con exito!",
	icon: "success",
	button: false, 
	timer: 20000 });
}
...
function habilitarEmpresa() {
	swal({title: "Enhorabuena!",
	text: "Empresa habilitada   con exito!",
	icon: "success",
	button: false, 
	timer: 20000 });
}