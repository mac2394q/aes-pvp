            ...
            <div class="content-header-dark bg-img col-12">
                <div class="row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <h3 class="content-header-title white titulo ">Módulo Auditoría - Empresa</h3>
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active parrafo">Ver Ficha de Auditoría - Perspectiva Empresa Ancla
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="list-inline mb-0">
                            ...
                            <li><a href="<?php echo "autoDiagnosticoAncla.php?id=".$idauditoria; ?>"
                                    class="btn capa text-white round btn-min-width mr-1 mb-1 waves-effect waves-light">
                                    <i class="fa fa-city"></i> Revisar Autodiagnostico de la Empresa Asociada </a>
                            </li>
                            <?php } ?>
