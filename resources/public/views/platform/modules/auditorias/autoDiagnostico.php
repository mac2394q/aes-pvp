                            ...
                            <div class="row breadcrumbs-top">
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <?php } ?>
                                        <li class="breadcrumb-item parrafo"><a class="text-white" href="<?php echo "verFicha.php?id=".$_GET['id']; ?>">Ver ficha de auditoria</a>
                                        </li>
                                        <li class="breadcrumb-item active parrafo">Proceso de autodiagnostico
                                        </li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse show">
                                        ...
                                        <div class="form-group ">
											<a  id="" class="btn round capa text-white waves-effect waves-light text-white">  <i class="fa fa-clipboard-check fa-2x"></i>&nbsp; Validar Autodiagnóstico</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
