                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item parrafo"><a
                                            href="<?php echo "verFicha.php?id=".$_GET['id']; ?>" class="text-white">Ver
                                            ficha de auditoria</a>
                                    </li>
                                    <li class="breadcrumb-item active parrafo">Proceso de seleccion de rubrica evaluadas
                                    </li>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h2 class="form-section"><i class="fa fa-business-time"></i>
                                            Plantilla PVP - Proceso de seleccion de rubricas para evaluacion</h2>
                                        <h4 class="card-title parrafo">Nota : Por defecto todas las rubricas estan
                                            seleccionadas ,si elige deseleccionar la rubrica no aparece para ser
                                            evaluada</h4>
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <div class="repeater-default">
                                                <div>
                                                    <div>
                                                        <?php auditoriasController::listadoGrupoAuditoriaItemSeleccion($_GET['id']); ?>
                                                        <hr>
                                                    </div>
                                                </div>
                                                <div id="top_bar2">
                                                    <a class="btn btn-secondary round waves-effect waves-light"
                                                        ...
                                                        <i class="fa fa-clipboard fa-2x"></i> &nbsp;&nbsp;Ver ficha de
                                                        auditoria
                                                    </a>
                                                </div>
