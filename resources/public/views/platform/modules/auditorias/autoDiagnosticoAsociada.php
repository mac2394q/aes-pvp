                        ...
                        <div class="content-header-left col-md-9 col-12 mb-2">
                            ...
                            <div class="row breadcrumbs-top">
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item parrafo"><a class="text-white" href="<?php echo "verFichaRolAnclaAsociada.php?id=".$_GET['id']."&vista=Asociada"; ?>"> Ficha de Auditoría</a>
                                        </li>
                                        <li class="breadcrumb-item active parrafo"> Realizar Autodiagnostico
                                        </li>
