                        ...
                        <div class="content-header-left col-md-9 col-12 mb-2">
                            ...
                            <div class="row breadcrumbs-top">
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item parrafo"><a class="text-white" href="<?php echo "verFichaRolAncla.php?id=".$_GET['id']."&vista=Ancla"; ?>"> Ficha de Auditoria</a>
                                        </li>
                                        <li class="breadcrumb-item active parrafo"> Revisar Autodiagnostico de la Empresa Asociada
                                        </li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <h4 class="card-title parrafo">Nota : Tener en cuenta que solo apareceran las rubricas de los capitulos que el auditor eligio para realizar la auditorio</h4>
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <div class="repeater-default">
                                                <div >
                                                    <div >
                                                        <?php auditoriasController::listadoGrupoAuditoriaItem2($_GET['id']); ?>
                                                        <hr>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group ">
											<a  id="" class="btn round capa text-white waves-effect waves-light text-white">  <i class="fa fa-clipboard-check fa-2x"></i>&nbsp; Validar plan de accion</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
