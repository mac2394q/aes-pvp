                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item parrafo"><a
                                            ...
                                            class="text-white">Gestion Documental Empresa</a>
                                    </li>
                                    <li class="breadcrumb-item active parrafo">Validación Representante Legal
                                    </li>
                                </ol>
                            </div>
                        </div>
                                                ...
                                                <div style="">
                                                    <div class="form row">
                                                        ...
                                                        <div class="form-group mb-1 col-sm-12 col-md-3">
                                                            ...
                                                            <input type="text" id="descripcion3" class="form-control"
                                                                placeholder=". . . " name="descripcion3">
                                                        </div>
