<?php 
  ...
  $f1=move_uploaded_file($temp_archivo,$directorio . "/".$_POST['idempresa']."_".$_POST['REPRESENTANTE']."_REPRESENTANTE.pdf");
  //echo $f1;

  $url =PLATFORM_SERVER."modules/empresa/validacionRepresentante.php?id=".$_POST['idempresa']; 
