      ...
      <div class="content-header-dark bg-img col-12">
        <div class="row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <h3 class="content-header-title white"><i class="fa fa-mail-bulk"></i> Módulo Auditorias</h3>
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item active parrafo">Listado de Auditorias de la Empresa</li>
                </ol>
              </div>
            </div>
          </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-2">
                        <div class="form-group"><br>
                          <button class="btn capa btn-success" type="button" id="consultar_auditoria">
                      ...
                      <div class="col-md-12">
                        <div id="tablaDinamica_panel">
                          <?php auditoriasController::listadoSimpleAuditoriaEmpresaAuditor("az","te","sin_estado",null,$_GET['id']); ?>
                        </div>
                      </div>
