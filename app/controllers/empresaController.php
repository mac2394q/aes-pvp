...
class empresaController
{
    ...
    public static function listadoSimpleEmpresasAsociar($idempresa,$rol){
        ...
        echo   "<table id='project-task-list' class='table table-responsive-md table-white-space table-bordered row-grouping display no-wrap icheck table-middle dataTable'
                    ...
                    <thead>
                        <tr role='row'>
                            <th class='titulo' rowspan='1' colspan='1' ><li class='fa fa-money-check'></li>  Perfil
                            </th>
                            <th class='titulo' rowspan='1' colspan='1' ><li class='fa fa-money-check'></li>  Nombre
                            </th>
                           ...
                           echo " <th class='titulo' rowspan='1' colspan='1' ><li class='fa fa-minus-circle'></li>  Desasociar Empresa
                            </th>";
                            }
                            echo "
                        </tr>
                    ...
                    <tbody>
                        ...
                        echo"
                        <tr role='row' class='even'>
                            <td><a href='".MODULE_APP_SERVER."empresa/verFichaAncla.php?id=".$objEmpresa[$key]->getIdempresarial()."' class='btn capa text-white round '><i class='fa fa-clipboard-list fa-2x'></i> </a></td>
                            <td class='parrafo'>
                              ".$objEmpresa[$key]->getNombre_empresa()."
                            </td>
                            <td class='parrafo'>
                            ...
                            ";
                           if($rol == "ADMINISTRADOR"){
                            echo "<td><a href='".MODULE_APP_SERVER."empresa/core/desasociarEmpresa.php?id=".$idempresa."&id2=".$objEmpresa[$key]->getIdempresarial()."' class='btn btn-danger round '><i class='fa fa-ban fa-2x'></i> </a></td>";
  ...
  public static function listadoEmpresaSedes($idempresa){
    ...
    public static function listadoDocumentosEmpresaValidacion($idempresa,$empresa){
        ...
        if($objCertificados != false){
            ...
            $url2 = DOCUMENTS_PATH."documentos/empresa/".$_GET['id']."/".$objCertificados[$key]->getidempresa_asignacion()."_".$objCertificados[$key]->getidvalidacion_empresa()."_".$empresa.".pdf";
            ...
            <div class='form-group mb-1 col-sm-12 col-md-2'>
                ...
                <br><br>
                <a href='".$url."' class='btn capa text-white round '><li class='fa fa-file-pdf fa-2x'></li>&nbsp;&nbsp;Ver Documento</a>
            </div>
            <div class='form-group mb-1 col-sm-12 col-md-2'>
                
                <br><br>
                <a href='core/eliminarValidacionEmpresa.php?id=".$objCertificados[$key]->getidempresa_asignacion()."&id2=".$objCertificados[$key]->getidvalidacion_empresa()."&url=".$url2."'   class='btn btn-danger round '><li class='fa fa-ban fa-2x'></li>&nbsp;&nbsp;Eliminar Documento</a>
            </div>
